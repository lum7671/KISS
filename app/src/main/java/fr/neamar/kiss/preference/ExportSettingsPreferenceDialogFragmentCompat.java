...
/**
 * Dialog fragment for ExportSettingsPreferenceCompat.
 * Handles the export of all KISS settings to JSON format in clipboard.
 */
public class ExportSettingsPreferenceDialogFragmentCompat extends PreferenceDialogFragmentCompat {

    private static final String TAG = ExportSettingsPreferenceDialogFragmentCompat.class.getSimpleName();

    public static ExportSettingsPreferenceDialogFragmentCompat newInstance(String key) {
        ExportSettingsPreferenceDialogFragmentCompat fragment = new ExportSettingsPreferenceDialogFragmentCompat();
