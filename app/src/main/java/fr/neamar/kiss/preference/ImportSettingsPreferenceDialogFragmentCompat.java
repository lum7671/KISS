...
/**
 * Dialog fragment for ImportSettingsPreferenceCompat.
 * Handles the import of KISS settings from JSON format in clipboard.
 */
public class ImportSettingsPreferenceDialogFragmentCompat extends PreferenceDialogFragmentCompat {

    private static final String TAG = ImportSettingsPreferenceDialogFragmentCompat.class.getSimpleName();

    public static ImportSettingsPreferenceDialogFragmentCompat newInstance(String key) {
        ImportSettingsPreferenceDialogFragmentCompat fragment = new ImportSettingsPreferenceDialogFragmentCompat();
